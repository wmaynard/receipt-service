...
namespace Rumble.Platform.ReceiptService.Models
{
    public class AppleValidation : Validation
    {
        ...
        public AppleValidation(string environment, int isRetryable, byte? latestReceipt, List<string> latestReceiptInfo,
            List<string> pendingRenewalInfo, Receipt receipt, int status)
        {
