...
public class AppleValidation : Validation
{
    ...
    internal const string DB_KEY_APPLE_RECEIPT = "aplRcpt";
    internal const string DB_KEY_STATUS = "status";

    public const string FRIENDLY_KEY_ENVIRONMENT = "environment";
    public const string FRIENDLY_KEY_APPLE_RECEIPT = "appleReceipt";
    ...
    [BsonElement(DB_KEY_APPLE_RECEIPT)]
    [JsonInclude, JsonPropertyName(FRIENDLY_KEY_APPLE_RECEIPT), JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public AppleReceipt AppleReceipt { get; set; } // may have to make sure the format works for apple
